		...
		<div class="top">
			...
			<form name="student" method="post" action="/student/add">
				<ul class="info clearfix">
					...
					<li class="three"><span>班级</span><input type="text"
						name="classes"></li>
					<li class="four"><span>问卷状态</span><input type="text"
						name="qsstate"></li>
					<li class="five"><span>状态</span><input type="text"
						name="stustate"></li>
					<!-- <li class="sex"><span>时间</span><input type="text" name="registtime"></li> -->
					<li class="seven"><span>用户名</span><input type="text"
						name="username"></li>
					<li class="eight"><span>密码</span><input type="text"
						name="password"></li>
