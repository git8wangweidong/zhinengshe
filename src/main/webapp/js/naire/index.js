...
$('#dropzone').droppable({
  ...
  drop: function (e, ui) {
    ...
    if(type=='a1'){
          var $el = $('<div class="drop-item"><details><summary >' + ui.draggable.text() + '</summary><div><input type="radio" class="danxuan"/><label>选项一</label><span id="ac">fdsasfafdass</span></div><input type="radio" /><label>选项二</label></div></details></div>');
