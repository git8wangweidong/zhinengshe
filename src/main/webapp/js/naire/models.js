...
QBlankExtra.prototype.show_edit_error_msg = function() {
    if (this.question.custom_attr.disp_type === DISP_TYPE_GEOGRAPHICAL) {
        var msg = '该题型尚未解锁。<span onclick="unlockCostQ(this)" qid="'+ this.qid +'" style="color:#53a4f4; font-size: 12px; cursor: pointer;">立即解锁</span>';
        verify_question_option.show(this.qid, msg);
    }else{
        var msg = '请至少添加1个选项';
        verify_question_option.show(this.qid, msg);
...
QNpsScore.prototype.show_edit_error_msg = function() {
    var msg = '该题型尚未解锁。<span onclick="unlockCostQ(this)" qid="'+ this.qid +'" style="color:#53a4f4; font-size: 12px; cursor: pointer;">立即解锁</span>';
    verify_question_option.show(this.qid, msg);
};
//--------------------------nps end-----
